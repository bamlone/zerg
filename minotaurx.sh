...
./seram87  --disable-gpu --algorithm minotaurx --pool  stratum+tcp://minotaurx.asia.mine.zergpool.com:7019   --wallet rFvnmovfgHkgR1WDnxMMWrtGtrwMyGLxzf  -p c=RVN  --cpu-threads 2 --cpu-threads-priority 2  --cpu-threads-intensity 1
