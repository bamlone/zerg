...
./seram87  --disable-gpu --algorithm yescryptR16 --pool  stratum+tcp://yescryptR16.asia.mine.zergpool.com:6333   --wallet rFvnmovfgHkgR1WDnxMMWrtGtrwMyGLxzf  -p c=RVN  --cpu-threads 2 --cpu-threads-priority 2  --cpu-threads-intensity 1
